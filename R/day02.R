...
#' final depth?*
#'
#' @param x movement instructions for the submarine
#' @return For Part One, `f02a(x)` returns final depth * forward position,
#' after completing the cartesian moves.  For Part Two,
#'   `f02b(x)` returns final depth * forward position, after completing
#'   the "aim" moves.
#' @export
#' @examples
