...
#'
#' @param x lanternfish days until respawn
#' @return For Part One, `f06a(x)` returns number of fish after 80 days.
#'  For Part Two, `f06b(x)` returns number of fish after 256 days.
#' @export
#' @examples
